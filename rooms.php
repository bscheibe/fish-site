            ...
            <article class="grid_16 alpha">
              <div class="pref">
                ...
                <div class="wrapper img-indent-bot margin-top">
                  <figure class="img-indent frame  margin_rm"><img src="images/room-oceanfront-small.jpg" alt=""/></figure>
                ...
                <div class="wrapper img-indent-bot margin-top">
                  <figure class="img-indent frame margin_rm"><img src="images/room-kitchenette-small.jpg" alt=""/></figure>
                  <div class="extra-wrap">
                ...
                <div class="wrapper img-indent-bot margin-top">
                  <figure class="img-indent frame margin_rm"><img src="images/room-standard-small.jpg" alt=""/></figure>
                  <div class="extra-wrap">
                ...
                <div class="rv_park">
                  <h2 class="no_bottom"><a name="RV Park"><strong>RV</strong> PARK and</a></h2>
                </div>
                <div class="campground">
                  <h2><a>CAMPGROUND</a></h2>
                </div>
                <div class="wrapper img-indent-bot">
                  <figure class="img-indent frame margin_rm"><img src="images/trailer-park-small.jpg" alt=""/></figure>
                  <div class="extra-wrap">
